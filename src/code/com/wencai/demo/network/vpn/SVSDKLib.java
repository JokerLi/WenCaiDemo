package com.wencai.demo.network.vpn;
...
public class SVSDKLib {
        ...
        if(sresip != null && sresip.length() != 0) {
            if(nresport > 0 && nresport <= '\uffff') {
                if(nreslocalport > 0 && nreslocalport <= '\uffff') {
                    ...
                    Log.e("SVSDKLib", "要使用的本地端口设置错误");
                    return -1;
                }
            } else {
                Log.e("SVSDKLib", "资源端口设置错误");
                return -1;
            }
        } else {
            Log.e("SVSDKLib", "资源地址设置错误");
            return -1;
        }
    }
    ...
    private boolean IsClientExsist(String sfilename) {
        ...
        try {
            ...
            if((new File(exp)).exists()) {
                ...
                Log.d("SVSDKLib", "File not found,should get it from asserts directory");
                ret = false;
            }
        ...
        if(this.IsClientExsist(sfilename)) {
            ...
            try {
                if(this.appam == null) {
                    ...
                    fos.close();
                    exp.close();
                    Log.d("SVSDKLib", "Total write " + total + " bytes into " + filepath);
    ...
    public void prepareVPNSettings() {
        ...
        Log.i("SVSDKLib", "prepareVPNSettings done");
    }
    ...
    public void startVPN() {
        ...
        if(!this.bRunningStatusThread) {
            (new SVSDKLib.GetVPNClientStatusrThread()).start();
        }

        this.bRunningStatusThread = true;
        (new SVSDKLib.LoginVPNThread()).start();
    }

    public void reLoginVPN() {
        this.mVPNStatus = "0";
        this.mVPNError = "0";
        Log.i("SVSDKLib", "relogin to vpn");
        this.bRunningStatusThread = false;
        ...
        this.bRunningStatusThread = true;
        (new SVSDKLib.ReLoginVPNThread()).start();
    }
    ...
    private void writeConfigfile() throws IOException {
        ...
        if(file.exists()) {
            Log.v("SVSDKLib", "exsit file delete");
            file.delete();
        }
    ...
    private int RedoGetSidByPwd() {
        ...
        Log.i("SVSDKLib", "relogin mCmd = " + mCmd);
        Runtime runtime = Runtime.getRuntime();
        int exitCode = 2147483647;
    ...
    private class GetVPNClientStatusrThread extends Thread {
        ...
        public void run() {
            try {
                ...
                SVSDKLib.this.m_GetClientMsgPort = '谼';
                SVSDKLib.this.bGetClientMsgSocketOK = false;

                try {
                    socket = new DatagramSocket(SVSDKLib.this.m_GetClientMsgPort, IPAddress);
                } catch (SocketException var18) {
                    Log.i("SVSDKLib", "DatagramSocket err:  " + var18.getMessage());
                ...
                while(SVSDKLib.this.bRunningStatusThread) {
                    try {
                        ...
                        if(e.equalsIgnoreCase("6")) {
                            ...
                            if(SVSDKLib.this.bUsePreSetRes) {
                                ...
                                var26.put("resip", SVSDKLib.this.m_ResAddr);
                                var26.put("resport", Integer.toString(SVSDKLib.this.m_ResPort));
                                var26.put("reslocalport", Integer.toString(SVSDKLib.this.m_ResLocalPort));
                                SVSDKLib.this.ResList.add(var26);
                            } else {
                                for(nResCnt = 0; nResCnt < ret; ++nResCnt) {
                                    ...
                                    SVSDKLib.this.ResList.add(resitem);
                                }
                            }

                            Bundle var24 = new Bundle();
                            var24.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                            var24.putString("vpnerror", SVSDKLib.this.mVPNError);
                            SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, var24);
                        ...
                        if(!e.equalsIgnoreCase("7")) {
                            ...
                            if(e.equalsIgnoreCase("200")) {
                                ...
                                var22 = new Bundle();
                                var22.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                                var22.putString("vpnerror", SVSDKLib.this.mVPNError);
                                SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, var22);
                            ...
                            reader = new ConfigReader(svportswiftPath);
                            SVSDKLib.this.mUDPCmdPort = reader.getIntValue("portswift", "udpcmdport");
                            ...
                            var28.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                            var28.putString("vpnerror", SVSDKLib.this.mVPNError);
                            SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, var28);
    ...
    private class LoginVPNThread extends Thread {
        ...
        public void run() {
            try {
                boolean e = false;
                int e2 = SVSDKLib.this.doGetSidByPwd();
                SVLoginParam LoginParam = SVLoginParam.getInstance();
                TopSVParam param = LoginParam.getTopSVParam();
                int cmd;
                Bundle e1;
                if(e2 != 0) {
                    if(param.pMsg.length() > 0) {
                        cmd = SVSDKLib.this.GetErrCodeFromMsg(param.pMsg);
                        if(cmd == '鲍') {
                            ...
                            SVSDKLib.this.mVPNStatus = "0";
                            e1.putString("vpnerror", SVSDKLib.this.mVPNError);
                            e1.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                            SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, e1);
                            Log.e("SVSDKLib", "VPN登陆失败");
                            return;
                        }
                    ...
                    e1.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                    SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, e1);
                    Log.e("SVSDKLib", "0000VPN登陆失败");
                    SVSDKLib.this.bRunningStatusThread = false;
                    return;
                }

                e2 = SVSDKLib.this.doGetResList();
                LoginParam = SVLoginParam.getInstance();
                if(e2 != 0) {
                    Bundle cmd2 = new Bundle();
                    SVSDKLib.this.mVPNError = "" + e2;
                    SVSDKLib.this.mVPNStatus = "0";
                    cmd2.putString("vpnerror", SVSDKLib.this.mVPNError);
                    cmd2.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                    SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, cmd2);
                    Log.e("SVSDKLib", "VPN获取资源失败");
                    (SVSDKLib.this.new PostLogOutThread()).start();
                    SVSDKLib.this.bRunningStatusThread = false;
                    return;
                }
                ...
                if(resnum == 0) {
                    Log.e("SVSDKLib", "没有可用的VPN资源，请与管理员联系查看VPN的配置是否正确");
                    SVSDKLib.this.bRunningStatusThread = false;
                    (SVSDKLib.this.new PostLogOutThread()).start();
                    return;
                }

                cmd1 = SVSDKLib.this.mSVClientPath + "/" + SVSDKLib.this.mSVClient;
                ...
                try {
                    ...
                    Log.i("SVSDKLib", "writeConfigfile or run cmd err");
                }
        ...
        public void run() {
            try {
                ...
                try {
                    ...
                    Log.e("SVSDKLib", String.format("Run Cmd %s error: %s", new Object[]{mCmd, var17}));
                }
    ...
    private class ReLoginVPNThread extends Thread {
        ...
        public void run() {
            try {
                boolean e = false;
                int e2 = SVSDKLib.this.RedoGetSidByPwd();
                SVLoginParam cmd;
                if(e2 != 0) {
                    cmd = SVLoginParam.getInstance();
                    TopSVParam e3 = cmd.getTopSVParam();
                    if(e3.pMsg.length() > 0) {
                        int reader1 = SVSDKLib.this.GetErrCodeFromMsg(e3.pMsg);
                        if(reader1 == '鲍') {
                            Bundle resnum1 = new Bundle();
                            SVSDKLib.this.mVPNError = "10";
                            SVSDKLib.this.mVPNStatus = "0";
                            resnum1.putString("vpnerror", SVSDKLib.this.mVPNError);
                            resnum1.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                            SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, resnum1);
                            Log.e("SVSDKLib", "VPN登陆失败");
                            return;
                        }
                    }
                    ...
                    SVSDKLib.this.mVPNError = "" + e2;
                    SVSDKLib.this.mVPNStatus = "0";
                    reader2.putString("vpnerror", SVSDKLib.this.mVPNError);
                    reader2.putString("vpnstatus", SVSDKLib.this.mVPNStatus);
                    SVSDKLib.this.SendMsg(SVSDKLib.this.MsgHandler, SVSDKLib.this.VPNMsgID, reader2);
                    Log.e("SVSDKLib", "VPN登陆失败");
                    SVSDKLib.this.bRunningStatusThread = false;
                    return;
                }
                ...
                String cmd1 = SVSDKLib.this.mSVClientPath + "/" + SVSDKLib.this.mSVClient;
