...
import com.ijinshan.liemo.network.vpn.SVSDKLib;
import com.ijinshan.liemoapp.R;

public class VPNActivity extends Activity implements OnClickListener {
    ...
    // VPN服务器地址、端口号、用户名、密码
    private final String VPN_SERVER = "67.229.163.54";
    private final int VPN_PORT = 443;
    private final String VPN_USERNAME = "275327";
    private final String VPN_PASSWORD = "liguoqing1991@";
            ...
            switch (msg.what) {
                case VPN_MSG_STATUS_UPDATE: // VPN库发送消息处理
                {
                    if (null != bundle) {
                        ...
                        if (vpnStatus.equalsIgnoreCase("6")) {
                            ...
                            Toast.makeText(VPNActivity.this, "VPN库消息通知：VPN隧道建立成功",
                                    Toast.LENGTH_SHORT).show();
                        }

                        if (vpnStatus.equalsIgnoreCase("200")) {
                            Toast.makeText(VPNActivity.this, "VPN库消息通知：VPN隧道超时",
                                    Toast.LENGTH_SHORT).show();
                        }
                ...
                case QUERY_VPN_MSG_STATUS_UPDATE: // 查询线程消息处理
                {
                    if (null != bundle) {
                        ...
                        if (vpnStatus.equalsIgnoreCase("6")) {
                            // VPN隧道建立成功
                            Toast.makeText(VPNActivity.this, "查询线程通知：VPN隧道建立成功",
                                    Toast.LENGTH_SHORT).show();
                        }
...
//		 new GetVPNStatusThread().start();
    ...
    private void doGetVPNStatus() {
        ...
        Toast.makeText(VPNActivity.this, "当前VPN状态为：" + sVPNStatus,
                Toast.LENGTH_SHORT).show();
