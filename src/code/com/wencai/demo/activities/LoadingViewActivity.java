...
public class LoadingViewActivity extends Activity{
    ...
    private void initPagerItems() {
        ...
        mPagerItems.add(com.wencai.demo.views.loadings.loading1.LoadingView.class.getName());
        mPagerItems.add(com.wencai.demo.views.loadings.loading2.LoadingView.class.getName());
    }
